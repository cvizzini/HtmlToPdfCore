...
namespace HtmlToPdfCore.Data;

/// <summary>
/// Builds hardcoded sample data for demonstrating PDF generation.
/// In a real application, replace this with data sourced from a database,
/// API, or user input.
/// </summary>
public static class SampleDataFactory
{
    public static QuoteTemplateData BuildQuoteTemplateData() => new(
        ...
        User:          "Test Person",
        Watermark:     string.Empty);   // Pass "DRAFT" here to watermark the document
